  ...
  return (
    <SafeAreaView className="w-full flex-1 flex bg-white" edges={["top"]}>
      <Modal isVisible={modal}>
        <View className="bg-white py-3 px-7 rounded-xl">
          <Text
          ...
          >
            ...
            >
              <View className="px-10 py-2 rounded-lg bg-primaryblue-200 border border-primaryblue-200">
                <Text className="font-kanit text-text-2 text-lg">ยืนยัน</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
      ...
      <View className="rounded-t-[60px] h-[70vh] w-full bg-white relative bottom-32 flex items-center">
        ...
        <ScrollView className="px-3 flex flex-col mt-16 w-full ">
